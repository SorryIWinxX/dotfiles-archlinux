...
function validateAddress() {
    ...
    var address = document.getElementById('name1').value; //value of input
    var address1 = document.getElementById('name1'); // All element of input
    var addressControl= address1.parentNode; // Node father to element
    let re = new RegExp('cll+cra+av+anv+trans');
