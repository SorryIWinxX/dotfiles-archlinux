...
function nextFun(){
    const  stepBarCurrent = document.getElementsByClassName('step-wizard-item current-itemstep-wizard-item');
    const stepBarNotCurrent = document.getElementsByClassName('step-wizard-item');

    console.log(stepBarNotCurrent);
