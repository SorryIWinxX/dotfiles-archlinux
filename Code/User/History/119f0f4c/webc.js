...
function nextFun(){
    const  stepBarCurrent = document.getElementById('stepBarCurrent');
    const stepBarNotCurrent = document.getElementById('stepBarNotCurrent');

    stepBarCurrent.className='step-wizard-item';
    stepBarNotCurrent.className='step-wizard-item current-item';
