...
# https://github.com/iWas-Coder/iQtile
...
keys = [
    ...
    #Volumen Controls
    Key([mod, "XF86AudioRaiseVolume"], "s", lazy.spawn("pactl set-sink-volume 0 +5%")),
    Key([mod, "XF86AudioLowerVolume"], "s", lazy.spawn("pactl set-sink-volume 0 -5%")),
]
